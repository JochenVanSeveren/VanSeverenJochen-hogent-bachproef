...
% TODO: Titel moet niet per se de vraag zijn
% \title{Hoe kan de integratie tussen moderne cross-platform applicaties en ERP-systeem Odoo worden gerealiseerd voor een efficiënte, naadloze en veilige afhandeling van financiële transacties en gegevensbeheer TODO sales orders? in het kader van verfafvalwaterdeposits door schilders?}
...
\email{jochen.vanseveren@student.hogent.be}

% Indien T. Bours niet volstaat, Jelle Verheyen?
\supervisor[Co-promotor]{T. Bours (\href{https://www.cleanwaterglobal.eu/}{Clean Water Global})}
...
\keywords{Cross Platform App, Odoo Api, Regelgeving Verfafvalwater}

\begin{document}

% Note: focus ligt niet op app, maar op de app mogelijk te maken op Odoo
